          ...
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              <i>
                ...
                well as exploring the exciting domains of{" "}
                <b className="purple">
              ...
              <br />
              <br />
              Whenever possible, I also channel my passion into developing solutions using <i><b className="purple">React.js, Spring</b></i> and
              <i>
                <b className="purple">
                  {" "}
                  cutting-edge tools
